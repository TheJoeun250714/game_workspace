...
part = 이 파일은 다른 Dart 파일들이랑 한 몸이다.
현재 dart 파일의 코드를 파일 분할하여 작성할 때 사용

dart run build_runner build --delete-conflicting-outputs
명령어로 아래 파일을 자동 생성 하기 전까지는 빨간표기로 되어 있는 것이 정상
아래 구문 ↓↓↓↓↓
...
_$ClassModels = dio, freezed, retrofit / json_serializable 를 사용할 때 빼고는 작성할 일 없음

_ = private $ = 변수나 함수, 클래스 이름 표기   ClassModels 는 클래스 이름 표기

part 작성한 코드는  중괄호 내부에 나눠진 코드들이 작성되어 있는 것과 같은 효과로
한 파일 내에서 쓰여지는 형태
 */
/*
@freezed
...
필요한 형태들 모두 생성 json  map->json 이외 다양하게 변형해야할 모든 경우의 수를 다 생성
 */
